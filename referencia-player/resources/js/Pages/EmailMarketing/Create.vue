...
import { defaultCampaignMessage } from '@/lib/emailCampaignBody';
import { defaultFilterConfig, recipientTypeLabel } from '@/lib/emailCampaignFilters';
...
const form = useForm({
    name: '',
    subject: '',
    body_message: props.default_message_text || defaultCampaignMessage(),
...
<template>
    <div class="mx-auto max-w-5xl space-y-6">
        ...
        <form
            ...
            @submit.prevent="form.post('/plataforma/email-marketing')"
        >
            <div>
